...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var precio, noticias, token, url, resPrecio, resNoticias, resEventos;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          token = 'W7VR7QBLFJMW5BHX2365'; //const eventos= await fetch(`https://www.eventbriteapi.com/v3/events/search/?q=Bitcoin&sort_by=date&token=${token}&location.address=Mexico`);

          url = "https://www.eventbriteapi.com/v3/events/search/?q=bitcoin&sort_by=date&token=".concat(token);
          _context.next = 10;
          return precio.json();
        ...
        case 13:
          ...
          _context.next = 16;
          return axios__WEBPACK_IMPORTED_MODULE_8___default()(url);
...
//# sourceMappingURL=index.js.4f3fb21d3b22a69e9eb2.hot-update.js.map